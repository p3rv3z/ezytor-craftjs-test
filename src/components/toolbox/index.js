...
import { Section } from '../elements/Section';
import { ColumSection } from '../elements/ColumSection';
                        ...
                        <div className="_add_tab_elements_container">
                                ...
                                <div className="_add_tab_section_layout_wrap">
                                    <div className="_add_tab_section_layout_inner" ref={ref => connectors.create(ref, <Element is={Section} id="section" canvas />)}>
                                        <div className="_add_tab_icon">
                                            <svg data-icon="index" aria-hidden="true" focusable="false" width="62" height="50" viewBox="0 0 62 50" className="bem-Svg">
                            ...
                            <div className="_add_tab_section_layout">
                                ...
                                <div className="_add_tab_section_layout_wrap">
                                    ...
                                    <div className="_add_tab_section_layout_inner">
                                        <div className="_add_tab_icon">
                                            <svg data-icon="index" aria-hidden="true" focusable="false" width="56" height="29" viewBox="0 0 56 29" className="bem-Svg"><path opacity=".4" d="M56 17v-4h-2V9H22v8H0v12h36v-4h19v-4h-1v-4h2zm-1-3v2-2zm-32 0v2-2zm-4.1 2l.8.2.3-.7.8-1.7.5-1-1-.4c-1.1-.4-2-1.3-2.4-2.3H21V0H11v6.5c0 4.9 3 8.5 7.9 9.5zm-2.2-7H20h-3.3zm-8.8 7l.8.2.3-.8.8-1.7.5-1-1-.4c-1.1-.4-2-1.3-2.4-2.3H10V0H0v6.5C0 11.4 3 15 7.9 16zm1-2.7l-.5 1 .5-1C7.7 12.8 6.7 12 6.2 11c.5 1 1.5 1.8 2.7 2.3zM5.7 9H9V1v8H5.7z"></path><path fill="#fff" d="M23 14v2h32v-2H23zm30 4H1v2h52v-2zm0-8H23v2h30v-2zM1 24h53v-2H1v2zm0 4h34v-2H1v2zM1 6.5c0 4.6 2.9 7.7 7.1 8.5l.8-1.7c-2-.8-3.2-2.5-3.2-4.3H9V1H1v5.5zM20 1h-8v5.5c0 4.6 2.9 7.7 7.1 8.5l.8-1.7c-1.9-.7-3.2-2.5-3.2-4.3H20V1z"></path></svg>
                                        </div>
                                        <div className="_add_tab_icon_txt">
