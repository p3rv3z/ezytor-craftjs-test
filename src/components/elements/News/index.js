...
export const News = ({ children }) => {
	...
	// const testJsxParser = <JsxParser
	// 	components={{ TestDiv, TestP }}
	// 	jsx={`<TestDiv>
	...
	const testJsxParser = (<div><JsxParser
		bindings={{
			foo: 'bar',
			hello: () => { console.log('tesdsfsdfdsf') },
		}}
		components={{TestDiv, TestH1}}
		jsx={`<TestDiv><TestH1>{foo}</ TestH1></ TestDiv>`}
	/></div>)

	// console.log(testJsxParser)
	...
	const addCol = async () => {
		...
		const html = (<div style={{ background: '#262a34' }}>
		...
		const html2 = (<header className="_header_darefit_wrapper" id="header">
			<nav className="navbar navbar-expand-lg navbar-dark _header_darefit_navbar">
				<div className="container">
					<div className="_header_logo">
						<a className="navbar-brand _logo" href="#0">
					...
					<div className="collapse navbar-collapse _header_darefit_nav" id="navbarNav">
						<ul className="navbar-nav _header_darefit_nav_ul ms-auto">
							...
							<li className="nav-item dropdown _header_darefit_nav_li">
								<a href="#0" className="_header_darefit_nav_item">ClassName</a>
							</li>
							<li className="nav-item dropdown _header_darefit_nav_li">
								<a href="#0" className="_header_darefit_nav_item">About Us</a>
							</li>
		...
		const { data } = await axios.get('http://localhost:3333/dynamic-component')
		// console.log(JSON.parse(data.content))
		// console.log(typeof data.content)
		// const test = ReactHtmlParser(stringHtml)
		// console.log(test)
		let foo = 'bar';
		const names = ['a', 'b', 'c'];
		const testF = () => console.log('hello')
		...
		const nodeList = query.parseReactElement(testJsx).toNodeTree();
