                        ...
                        <div className="_add_tab_elements_container">
                            <div className="_add_tab_section_layout">
                                ...
                                <div className="_add_tab_section_layout_wrap">
                                    <div className="_add_tab_section_layout_inner" ref={ref=> connectors.create(ref, <Section/>)}>
                                    ...
                                    <div className="_add_tab_section_layout_inner" ref={ref=> connectors.create(ref, <Container/>)}>
                                        <div className="_add_tab_icon">
                            ...
                            <div className="_add_tab_section_layout">
                                ...
                                <div className="_add_tab_section_layout_wrap">
                                    <div className="_add_tab_section_layout_inner" ref={ref=> connectors.create(ref, <Heading text="Heading" />)}>
                                        <div className="_add_tab_icon">
